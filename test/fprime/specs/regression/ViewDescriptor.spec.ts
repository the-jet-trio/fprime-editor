  ...
  it("should build from FPP model", () => {
    const nodes: { [key: string]: INode } = {
      ins_1: {
        ...
        properties: { base_id: "1", key1: "val1", key2: "val2" },
      },
      ins_1_p1: {
        id: "ins_1_p1",
        modelID: "p1",
        type: NodeType.Port,
        properties: { direction: "out", kind: "async", "unused": true },
      },
      ins_1_p2: {
        id: "ins_1_p2",
        modelID: "p2",
        type: NodeType.Port,
        properties: { direction: "out", kind: "sync", "unused": true  },
      },
      ins_2: {
        id: "ins_2",
        modelID: "ins_2",
        type: NodeType.Instance,
        properties: { base_id: "2", key1: "val1" },
      },
      ins_2_p1: {
        id: "ins_2_p1",
        modelID: "p1",
        type: NodeType.Port,
        properties: { direction: "in", num: "2", kind: "async", "unused": true},
      },
      comp_1: {
        id: "comp_1",
        modelID: "comp_1",
